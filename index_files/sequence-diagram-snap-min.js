...
!function() {
    ...
    function handRect(x, y, w, h) {
        ...
        "M" + x + "," + y + wobble(x, y, x + w, y) + wobble(x + w, y, x + w, y + h) + wobble(x + w, y + h, x, y + h) + wobble(x, y + h, x, y)
    }
          ...
          , lexer = function() {
            var lexer = {
                ...
                next: function() {
                    ...
                    token !== !1 && token) : "" === this._input ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + ". Unrecognized text.\n" + this.showPosition(), {
                        text: "",
                        token: null,
                        line: this.yylineno
                    })
    ...
    if (_.extend(BaseTheme.prototype, {
        ...
        layout: function() {
            function actorEnsureDistance(a, b, d) {
                ...
                a.paddingRight = Math.max(d, a.paddingRight)) : (a = actors[a],
        ...
        drawSignals: function(offsetY) {
            ...
            _.each(this.diagram.signals, function(s) {
                "Signal" == s.type ? s.isSelf() ? this.drawSelfSignal(s, y) : this.drawSignal(s, y) : "Note" == s.type && this.drawNote(s, y),
                y += s.height
            }, this)
        },
        ...
        drawTextBox: function(box, text, margin, padding, font, align) {
            ...
            align == ALIGN_CENTER ? (x = getCenterX(box),
            y = getCenterY(box)) : (x += padding,
            y += padding),
    ...
    "undefined" != typeof Snap) {
        ...
        _.extend(SnapTheme.prototype, BaseTheme.prototype, {
            ...
            createText: function(text, font) {
                ...
                return t.attr(font || {}),
                text.length > 1 && t.selectAll("tspan:nth-child(n+2)").attr({
                    dy: "1.2em",
                    x: 0
                }),
                t
            ...
            drawLine: function(x1, y1, x2, y2, linetype, arrowhead) {
                ...
                return void 0 !== linetype && line.attr("strokeDasharray", this.lineTypes_[linetype]),
            ...
            drawText: function(x, y, text, font, align) {
                var t = this.createText(text, font)
                  , bb = t.getBBox();
                return align == ALIGN_CENTER && (x -= bb.width / 2,
                y -= bb.height / 2),
                t.attr({
                    x: x - bb.x,
                    y: y - bb.y
    ...
    Diagram.prototype.drawSVG = function(container, options) {
        ...
        if (options = _.defaults(options || {}, defaultOptions),
